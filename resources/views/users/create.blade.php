    ...
    <div class="add-container">
        <div class="add-card">
            ...
            <div class="add-header">
                ...
                <h1 class="add-title">Tambah User</h1>
                <p class="add-subtitle">Buat User Baru</p>
            </div>
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-field">
                            <input type="password" name="password" class="form-control" required placeholder="Minimal 8 karakter" id="password">
