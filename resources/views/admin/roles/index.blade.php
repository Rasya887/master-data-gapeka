...
<div class="management-container">
    <div class="management-card">
        ...
        <div class="management-header">
            ...
            <h1 class="management-title">Manajemen Role</h1>
            <p class="management-subtitle">Kelola Role & Hak Akses Pengguna</p>
        </div>
        ...
        <div class="management-body">
            <div class="action-buttons">
                ...
                <a href="{{ route('roles.create') }}" class="btn-primary-custom">
                    <span>➕</span>
                    Tambah Role
                </a>
            </div>
