...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-header">
            ...
            <h3 class="detail-title">Detail Daop</h3>
            <p class="detail-subtitle">Informasi Lengkap Daerah Operasi</p>
        </div>
        ...
        <div class="detail-body">
            <table class="detail-table">
                <tr>
                    <th>ID</th>
                    <td><span class="data-badge">{{ $daop->id }}</span></td>
                </tr>
                <tr>
                    <th>Nama</th>
                    <td><span class="highlight-value">{{ $daop->nama }}</span></td>
                </tr>
                <tr>
                    <th>Singkatan</th>
            ...
            <div class="button-container">
                <a href="{{ route('daop.index') }}" class="btn-back">
                    <span>🔙</span>
                    Kembali
                </a>
            </div>
