...
<div class="management-container">
    <div class="management-card">
        ...
        <div class="management-header">
            ...
            <h1 class="management-title">Manajemen Menu</h1>
            <p class="management-subtitle">Kelola Menu Sistem Dengan Mudah</p>
        </div>
        ...
        <div class="management-body">
            <div class="action-buttons">
                ...
                <a href="{{ route('menus.create') }}" class="btn-primary-custom">
                    <span>➕</span>
                    Tambah Menu
                </a>
            </div>
                    ...
                    <tbody>
                        @foreach($menus as $menu)
                            <tr>
                                ...
                                <td><span style="font-size: 1.2rem;">{{ $menu->icon }}</span></td>
                                <td><span class="order-badge">{{ $menu->menu_order }}</span></td>
                                <td>
                                    @if($menu->is_active)
                                ...
                                <td>
                                    <div class="action-buttons-cell">
                                        <a href="{{ route('menus.edit', $menu) }}" class="btn-sm btn-warning">
                                            <span>✏️</span>
                                            Edit
                                        </a>
                                        <form action="{{ route('menus.destroy', $menu) }}" method="POST" class="d-inline">
                                            @csrf 
                                            @method('DELETE')
                                            <button class="btn-sm btn-danger" onclick="return confirm('Hapus menu ini?')">
                                                <span>🗑️</span>
                                                Hapus
                                            </button>
                                        </form>
