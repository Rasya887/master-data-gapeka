<template>
  <Head title="Edit Data Jarak" />

  <div class="app-container">
    <div class="main-container">
      <div class="page-header">
        <h1 class="page-title">Edit Data Jarak</h1>
      ...
      <div class="data-card">
        <div class="card-header">
          <div class="header-info">
            ...
            <div>
              <h2 class="header-title">Formulir Edit Jarak</h2>
              <p class="header-subtitle">Perbarui data jarak antar stasiun</p>
            </div>
          </div>
        </div>
        ...
        <div class="form-container">
          <form @submit.prevent="submit" class="space-y-6">
            <div v-for="field in [
              ...
              { label: 'Lintas', model: 'id_lintas', options: id_lintas },
              { label: 'Tahun Gapeka', model: 'id_tahun_gapeka', options: tahun_gapeka },
            ]" :key="field.model" class="form-group">
              ...
              <div v-if="form.errors[field.model]" class="text-red-500 text-sm mt-1">{{ form.errors[field.model] }}</div>
            </div>
