      ...
      <div class="data-card">
        <div class="card-header">
          <div class="header-info">
            ...
            <div>
              <h2 class="header-title">Formulir Tambah Menu</h2>
              <p class="header-subtitle">Tambah menu baru ke sistem</p>
            </div>
          </div>
        </div>
        ...
        <div class="form-container">
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="form-group">
              ...
              <div v-if="form.errors.route" class="text-red-500 text-sm mt-1">{{ form.errors.route }}</div>
            </div>

            <div class="form-group">
              <label class="form-label">Urutan:</label>
              <input v-model.number="form.menu_order" type="number" class="form-input" />
              <div v-if="form.errors.menu_order" class="text-red-500 text-sm mt-1">{{ form.errors.menu_order }}</div>
            </div>
            ...
            <div class="mt-6 flex space-x-4">
              ...
              <Link href="/menus" class="btn-primary bg-gray-500 hover:bg-gray-600">
                Batal
              </Link>
            </div>
          </form>
...
function submit() {
  form.post('/menus', {
    onSuccess: () => alert('✅ Data menu berhasil disimpan.'),
    onError: (errors) => {
