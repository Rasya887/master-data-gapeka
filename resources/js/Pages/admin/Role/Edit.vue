      ...
      <div class="data-card">
        <div class="card-header">
          <div class="header-info">
            ...
            <div>
              <h2 class="header-title">Formulir Edit Role</h2>
              <p class="header-subtitle">Perbarui peran pengguna sistem</p>
            </div>
          </div>
        </div>
        ...
        <div class="form-container">
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="mt-6 flex space-x-4">
              ...
              <Link href="/roles" class="btn-primary bg-gray-500 hover:bg-gray-600">
                Batal
              </Link>
            </div>
          </form>
...
function submit() {
  form.put(`/roles/${props.role.id}`, {
    onSuccess: () => alert('✅ Data role berhasil diperbarui.'),
    onError: (errors) => {
